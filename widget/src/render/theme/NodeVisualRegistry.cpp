...
NodeVisualRegistry::NodeVisualRegistry() {
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{1},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{2},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{3},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{4},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{10},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{11},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{12},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{13},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{14},
    ...
    registerVisual(Engine::Core::Ids::NodeTypeId{15},
...
void NodeVisualRegistry::registerVisual(Engine::Core::Ids::NodeTypeId typeId, const NodeVisual& visual) {
    m_visuals[typeId.value()] = visual;
}

const NodeVisual& NodeVisualRegistry::getVisual(Engine::Core::Ids::NodeTypeId typeId) const {
