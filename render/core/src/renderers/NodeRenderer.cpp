...
void appendTextQuad(std::vector<ColorVertex>& vertices, float x0, float y0, float x1, float y1,
...
void appendTextGeometry(std::vector<ColorVertex>& vertices, const std::string& text, const glm::vec2& origin,
                        float pixelSize, float glyphAdvance, const glm::vec4& color) {
    float penX = origin.x;
...
NodeRenderStyle NodeRenderer::defaultStyle(Core::NodeTypeId typeId) {
    ...
    case 10:
        return {{0.12F, 0.14F, 0.18F, 0.96F},
                {0.09F, 0.11F, 0.16F, 1.0F},
                {0.34F, 0.42F, 0.58F, 0.95F},
                {0.36F, 0.43F, 0.56F, 1.0F},
                {0.86F, 0.63F, 0.27F, 1.0F},
                ...
                12.0F};
    case 11:
        return {{0.18F, 0.16F, 0.10F, 0.96F},
                {0.13F, 0.11F, 0.07F, 1.0F},
                {0.66F, 0.54F, 0.20F, 0.95F},
                {0.58F, 0.48F, 0.21F, 1.0F},
                {0.94F, 0.75F, 0.28F, 1.0F},
                {0.95F, 0.96F, 0.98F, 1.0F},
                ...
                12.0F};
    case 12:
        return {{0.10F, 0.16F, 0.23F, 0.96F},
                {0.07F, 0.11F, 0.17F, 1.0F},
                {0.28F, 0.52F, 0.82F, 0.95F},
                {0.25F, 0.53F, 0.76F, 1.0F},
                {0.51F, 0.82F, 1.0F, 1.0F},
                {0.95F, 0.96F, 0.98F, 1.0F},
                {0.90F, 0.97F, 1.0F, 1.0F},
                1.5F,
                28.0F,
                12.0F};
    case 13:
        return {{0.09F, 0.17F, 0.13F, 0.96F},
                {0.06F, 0.12F, 0.09F, 1.0F},
                {0.28F, 0.58F, 0.41F, 0.95F},
                {0.24F, 0.58F, 0.39F, 1.0F},
                {0.45F, 0.92F, 0.61F, 1.0F},
                {0.95F, 0.96F, 0.98F, 1.0F},
                {0.92F, 1.0F, 0.95F, 1.0F},
                1.5F,
                28.0F,
                12.0F};
    case 14:
        return {{0.20F, 0.11F, 0.12F, 0.96F},
                {0.14F, 0.08F, 0.09F, 1.0F},
                {0.72F, 0.28F, 0.37F, 0.95F},
                {0.62F, 0.29F, 0.33F, 1.0F},
                {0.98F, 0.58F, 0.56F, 1.0F},
                {0.95F, 0.96F, 0.98F, 1.0F},
                {1.0F, 0.93F, 0.94F, 1.0F},
                1.5F,
                28.0F,
                12.0F};
    case 15:
        return {{0.19F, 0.13F, 0.09F, 0.96F},
                {0.14F, 0.09F, 0.06F, 1.0F},
                {0.72F, 0.46F, 0.21F, 0.95F},
                {0.62F, 0.39F, 0.19F, 1.0F},
                {0.98F, 0.72F, 0.39F, 1.0F},
                {0.95F, 0.96F, 0.98F, 1.0F},
                {1.0F, 0.94F, 0.86F, 1.0F},
                1.5F,
                28.0F,
                12.0F};
    default:
...
void NodeRenderer::render(const std::vector<Scene::NodeRenderData>& nodes, const Camera::Camera2D& camera,
    ...
    for (const Scene::NodeRenderData& node : nodes) {
        ...
        appendConvexPolygon(fillVertices, topRoundedRectPoints(headerPos, headerSize, innerRadius, 8), headerColors,
                            headerPos, headerPos + headerSize);
        ...
        appendConvexPolygon(fillVertices,
                            topRoundedRectPoints(sheenPos, sheenSize, std::max(innerRadius - 3.0F, 2.0F), 6),
                            sheenColors, sheenPos, sheenPos + sheenSize);
        ...
        appendConvexPolygon(fillVertices, roundedRectPoints(iconPos, iconSize, 4.5F, 6), iconColors, iconPos,
                            iconPos + iconSize);
        ...
        appendConvexPolygon(fillVertices, roundedRectPoints(underlinePos, underlineSize, 0.8F, 3), underlineColors,
                            underlinePos, underlinePos + underlineSize);
    ...
    for (const Scene::NodeRenderData& node : nodes) {
        ...
        appendTextGeometry(textVertices, icon, iconOrigin + glm::vec2(0.55F, -0.45F), iconPixelSize,
                           iconPixelSize * 5.6F, shadowColor);
        appendTextGeometry(textVertices, title, titleOrigin + glm::vec2(0.8F, -0.55F), pixelSize, glyphAdvance,
                           shadowColor);
