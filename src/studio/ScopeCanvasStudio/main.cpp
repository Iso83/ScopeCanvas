...
int RunStudioApp()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (ImGui::BeginMainMenuBar())
        {
            ...
            {
                if (ImGui::MenuItem("Number")) basics.createNode(ScopeCanvas::Engine::Core::NodeTypeId{1}, {-120.0F, 0.0F});
                if (ImGui::MenuItem("Add")) basics.createNode(ScopeCanvas::Engine::Core::NodeTypeId{2}, {80.0F, 0.0F});
                if (ImGui::MenuItem("Multiply")) basics.createNode(ScopeCanvas::Engine::Core::NodeTypeId{3}, {280.0F, 0.0F});
                if (ImGui::MenuItem("Output")) basics.createNode(ScopeCanvas::Engine::Core::NodeTypeId{4}, {480.0F, 0.0F});
                ImGui::EndMenu();
            }
