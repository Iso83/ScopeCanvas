...
public:
    ...
    void renderEdges(const DiagramModel& model, const glm::mat4& viewProjection) const;
    void renderConnectors(const std::vector<Node>& nodes, const glm::mat4& viewProjection) const;
...
private:
    static std::vector<glm::vec2> sampleBezier(const glm::vec2& p0,
                                               const glm::vec2& p1,
                                               const glm::vec2& p2,
                                               const glm::vec2& p3,
                                               int segments);
