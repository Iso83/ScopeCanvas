...
void FlowViewport::onKey(int key, bool pressed) {
    ...
    switch (key) {
    case GLFW_KEY_A:
    case GLFW_KEY_LEFT: moveView({-180.0F, 0.0F}); break;
    case GLFW_KEY_D:
    case GLFW_KEY_RIGHT: moveView({180.0F, 0.0F}); break;
    case GLFW_KEY_W:
    case GLFW_KEY_UP: moveView({0.0F, 140.0F}); break;
    case GLFW_KEY_S:
    case GLFW_KEY_DOWN: moveView({0.0F, -140.0F}); break;
    default: return;
    }
